...
<body>
  ...
  <?php
    if (!empty($_POST['new_login']) and !empty($_POST['new_passwd']) and !empty($_POST['new_passwd_verif'])
    and !empty($_POST['new_email']) and $_POST['submit_new'] == "OK") {
      ...
      $db->confirmUser();
      if ($db->message)
        echo '<br /><div style="color:red;">' . $db->message . '</div>';
    }
  ?>
</body>
</html>
